...
exports.generateUrl = (userId, email) => {
  const baseUrl = `${MOONPAY_BASE_URL}?apiKey=${MOONPAY_API_KEY}&externalCustomerId=${userId}&email=${email}&currencyCode=${MOONPAY_CURRENCY_CODE}&walletAddress=${ONRAMP_WEBHOOK_WALLET}&colorCode=%23ffd401`;
