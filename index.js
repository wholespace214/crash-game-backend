...
async function main() {
  ...
  const { init, publishEvent, notificationEvents } = require('./services/notification-service');
  init(pubClient);
  ...
  subClient.on('message', (channel, message) => {
    ...
    if (messageObj.event === 'CASINO_TRADE') {
      publishEvent(notificationEvents.EVENT_CASINO_PLACE_BET, {
        producer: 'user',
        producerId: messageObj.data.userId,
        data: { ...messageObj.data },
        broadcast: true
      });
    } else if (messageObj.event === 'CASINO_REWARD') {
      ...
      if (messageObj.to === messageObj.data.userId) {
